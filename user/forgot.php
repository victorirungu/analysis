...
<head>
   ...
   <link rel="icon" href="../assets/images/logo/title.jpeg" type="image/x-icon">
    ...
    <title>Maisha Top - Forgot Password</title>
                ...
                <div style="margin: 0 auto; " class="col-xl-5 col-lg-6 me-auto">
                    <div class="log-in-box">
                        <div class="log-in-title">
                            <h3>Request reset password OTP</h3>
                        </div>

                        <div class="input-box">
                            <form id="forgotPassword" onsubmit="forgotPassword(event)" class="row g-4">
                                ...
                                <div class="col-12">
                                    <button  id="toDisable" class="btn btn-animation w-100 justify-content-center" type="submit">Request</button>
                                </div>
                            </form>
                        </div>
                    </div>
