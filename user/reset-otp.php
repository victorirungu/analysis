...
<head>
   ...
   <link rel="icon" href="../assets/images/logo/title.jpeg" type="image/x-icon">
    ...
    <title>Maisha Top - Reset OTP Verification</title>
            ...
            <div class="row">
                ...
                <div style="margin: 0 auto; " class="col-xl-5 col-lg-6 me-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                            <form id="verifyResetOtp" onsubmit="verifyResetOtp(event)" class="row g-4">
                                ...
                                <div class="col-12">
                                    <div class="form-floating theme-form-floating log-in-form">
                                        <input name="otp" type="number" class="form-control" id="otp" placeholder="Email Address" required/>
                                ...
                                <div class="col-12">
                                    <button  id="toDisable" class="btn btn-animation w-100 justify-content-center" type="submit">Verify</button>
                                </div>
                            </form>
                        </div>
                    </div>
