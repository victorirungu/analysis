...
<head>
    ...
    <title>Maisha Top - Reset Password</title>
            ...
            <div class="row">
                ...
                <div style="margin: 0 auto;" class="col-xl-5 col-lg-6 me-auto">
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
                            <form id="reset" onsubmit="resetPassword(event)" class="row g-4">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <button  id="toDisable" class="btn btn-animation w-100 justify-content-center" type="submit">Reset Password</button>
                                </div>
                            </form>
                        </div>
                    </div>
